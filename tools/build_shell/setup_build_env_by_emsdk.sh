...
cmake -DCMAKE_C_COMPILER=$C -DCMAKE_CXX_COMPILER=$CC -DCMAKE_BUILD_TYPE=Debug -DCMAKE_TOOLCHAIN_FILE=${EMSCRIPTEN}/cmake/Modules/Platform/Emscripten.cmake "-DCMAKE_MAKE_PROGRAM=$CLION_HOME/bin/ninja/win/x64/ninja.exe" -G Ninja -S .. -B .
popd
